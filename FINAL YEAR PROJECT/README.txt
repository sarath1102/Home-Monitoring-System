...
Dependencies to be installed before execurtion are as follows:
certifi==2020.6.20
chardet==3.0.4
click==7.1.2
cmake==3.18.2.post1
...
Upload images to be trained in "Trained_images" folder
The code below is to be saved as .py file and executed
